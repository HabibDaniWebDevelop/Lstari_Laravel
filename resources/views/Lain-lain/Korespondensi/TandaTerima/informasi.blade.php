<?php $title = 'Informasi Tanda Terima'; ?>
...
@section('Dashboard')
    ...
    <ol class="breadcrumb sm-2">
        ...
        <li class="breadcrumb-item ">Tanda Terima </li>
    ...
    <script>
        $(function() {
            $("#gridContainer").dxDataGrid({
                dataSource: '/Lain-lain/Korespondensi/TandaTerima/resource-informasi',
                ...
                "export": {
                    enabled: true,
                    fileName: "Informasi Tanda Terima",
