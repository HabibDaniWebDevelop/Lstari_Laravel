<div class="card-body">
    <div class="row">
        <div class="col-9">
            ...
            <input type="hidden" id="idNTHKOWorkshop" value="">
    ...
    <div class="row">
        <div class="col-3">
            <label class="form-label" for="idSPKOMatras">ID SPKO Matras :</label>
            <input type="number" disabled="" onchange="SearchSPKO()" value="" class="form-control" id="idSPKOMatras">
        </div>
        <div class="col-3">
            <label class="form-label" for="hasil">Hasil :</label>
            <select name="hasil" disabled id="hasil" class="form-select">
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <table class="table table-borderless table-sm" id="tabelItems">
