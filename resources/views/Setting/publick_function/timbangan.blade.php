...
@section('container')
    <h4 class="fw-bold py-3">
        <span class="text-muted fw-light"><a href="/">Home </a> /</span> {{ $title }}
    </h4>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row p-4">
                <div class="col-md-12 col-lg-6 col-xxl-4 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Timbang experimental 1</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control" id="experimental1" name="timbang[]" readonly  />
                                        <button type="button" class="btn btn-primary" onclick="kliktimbang('experimental1')"><span
                                            class="fas fa-balance-scale"></span></button>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Timbang experimental 2</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control" id="experimental2" name="timbang[]" readonly  />
                                        <button type="button" class="btn btn-primary" onclick="kliktimbang('experimental2')"><span
                                            class="fas fa-balance-scale"></span></button>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Timbang experimental 3</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control" id="experimental3" name="timbang[]" readonly  />
                                        <button type="button" class="btn btn-primary" onclick="kliktimbang('experimental3')"><span
                                            class="fas fa-balance-scale"></span></button>
                                </div>
                            </div>
                            ...
                            <input type="hidden" id="weight_realtime">
                        </div>
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <img src="{!! asset('assets/images/SettingTimbangan.jpg') !!}" >
                        </div>
                    </div>
                </div>
