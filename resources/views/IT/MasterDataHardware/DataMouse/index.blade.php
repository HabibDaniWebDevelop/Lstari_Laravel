...
@section('Dashboard')
    ...
    <ol class="breadcrumb sm-2">
        ...
        <li class="breadcrumb-item active">Data Mouse </li>
    </ol>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                @include('IT.MasterDataHardware.DataMouse.data')
...
$(".klik").on('click', function(e) {
    ...
    // ----------------------------------------------------------
        ...
        function kliktambah(id) {
            $("#jodulmodal1").html('Form Tambah Data Mouse');
            $('#modalformat').attr('class', 'modal-dialog modal-lg');
            $("#simpan1").removeClass('d-none');
            $('#simpan1').val('Tambah');

            $.get('DataMouse/create/', function(data) {
                $("#modal1").html(data);
        ...
        function klikedit(id) {
            $("#jodulmodal1").html('Form Edit Data Mouse');
            $('#modalformat').attr('class', 'modal-dialog modal-lg');
            $("#simpan1").removeClass('d-none');
            $('#simpan1').val('Edit');

            $.get(`/IT/MasterDataHardware/DataMouse/${id}/edit`, function(data) {
                $("#modal1").html(data);
                $('#modalinfo').modal('show');
            });
        }
        ...
        function klikcetak(id) {
            window.open('DataMouse/cetak?id=' + id, '_blank');
        }

        function klikCari() {
            if (event.keyCode === 13) {
                var id = $('#cari').val();
                window.location.replace('/IT/MasterDataHardware/DataMouse/search?id=' + id);
            }
        }
    </script>
