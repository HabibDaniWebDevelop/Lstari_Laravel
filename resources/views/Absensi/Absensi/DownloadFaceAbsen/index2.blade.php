...
@section('Dashboard')
    ...
    <ol class="breadcrumb sm-2">
        ...
        <li class="breadcrumb-item">Absensi </li>
        <li class="breadcrumb-item active">Download Face Absen </li>
    </ol>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                @include('Absensi.Absensi.DownloadFaceAbsen.data2')
...
@section('script')
    <script>
        ...
        function klikCari() {
            ...
            $.ajax({
                type:'POST',
                url:'/Absensi/Absensi/DownloadFaceAbsen/check',
        ...
        function KlikSimpan() {
            ...
            $.ajax({
                type: "POST",
                url: "/Absensi/Absensi/DownloadFaceAbsen",
                data: {startDate: startDate, endDate: endDate},
                dataType: 'json',
                beforeSend: function () {
                    $(".preloader").show();  
        ...
        function KlikPosting() {
            ...
            $.ajax({
                type: "POST",
                url: "/Absensi/Absensi/DownloadFaceAbsen/posting",
                dataType: 'json',
                cache: false,
                processData: false,
                contentType: false,
