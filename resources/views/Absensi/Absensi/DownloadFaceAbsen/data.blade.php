<div class="card-body">
    <div class="row">
        <div class="col-9">
            ...
            <input type="hidden" id="haveFaceAbsent" value="" type="text">
    ...
    <div class="row">
        <div class="col-3">
            ...
            <input type="date" disabled class="form-control" id="tanggalAwal" aria-describedby="tanggalAwal" value="{{$datenow}}">
        </div>
        <div class="col-3">
            <label for="tanggalAkhir" class="form-label">Tanggal Akhir</label>
            <div class="input-group">
                <input type="date" disabled class="form-control" id="tanggalAkhir" aria-describedby="tanggalAkhir" value="{{$datenow}}">
                <button class="btn btn-outline-primary" disabled type="button" id="Cari" onclick="klikCari()">Cari</button>
            </div>
        </div>
    </div>
    <hr>
