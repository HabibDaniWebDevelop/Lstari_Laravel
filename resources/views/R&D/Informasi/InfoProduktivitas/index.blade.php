<?php $title = 'Informasi Produktivitas Operator'; ?>
<?php $tab='1'; ?>
...
@section('Dashboard')
    ...
    <ol class="breadcrumb sm-2">
        ...
        <li class="breadcrumb-item active">Informasi Produktivitas Operator </li>
    </ol>
@endsection
...
<script>
        ...
        function show1(){
            $.ajax({
                    url: '/R&D/Informasi/InfoProduktivitas/getBulan',            
                    dataType : 'json',
                    type : 'GET',
        ...
        function gettingInfoProduktivitas(){
            var jenis = $("#jenis").val();
            var bln = $("#bulannya").val();
            var thn = $("#tahunnya").val();
            var area = $("#area").val();
            var data = {bln:bln, jenis:jenis, area:area, thn:thn};
            
        if(area == 1){
            alert('Maaf Informasi Untuk Area 2D Belum Tersedia !');
            ...
            $.ajax({
                url: '/R&D/Informasi/InfoProduktivitas/getInfoProduktivitas', 
                beforeSend: function(){
                    openModal();
                },              
                dataType : 'json',
                ...
                success: function(data)
                {
                    ...
                    var collapsedGroups = {};
                    var tabelstok =  $('#tabelproduktivitas').DataTable({
                        "paging": false,
                        "searching": true,
                        "ordering": true,
                        "info": false,
