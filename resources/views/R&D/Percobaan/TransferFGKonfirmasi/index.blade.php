<?php $title = 'Transfer FG Konfirmasi'; ?>
...
@section('Dashboard')
    ...
    <ol class="breadcrumb sm-2">
        ...
        <li class="breadcrumb-item active">Transfer FG Konfirmasi </li>
    </ol>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                @include('R&D.Percobaan.TransferFGKonfirmasi.data')
...
@section('script')
    <script>
        ...
        function getItemTM() {
            ...
            $.ajax({
                type: "POST",
                url: "/R&D/Percobaan/TransferFGKonfirmasi/getItemTM",
                data: data,
                dataType: 'json',
                beforeSend: function () {
                    $(".preloader").show();  
