...
<body>
    <table class="tabel0" style="background-color: #F0FFF0;">
        <tr>
            <td colspan="6" style="font-size:15px; padding-bottom: 10px; "><b style="font-size: 30px;">WIP Grafis </b>
            </td>
    ...
    <table class="table table-border table-hover table-sm" id="tabel1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="15%"><img src="{{Session::get('hostfoto')}}/image/{{$item->Photo}}.jpg" style="height: 50px; width:80px" onerror="this.onerror=null; this.src='{!! asset('assets/images/no-photos.jpg') !!}'"></td>
                ...
                @if (is_null($item->variasi))
                    <td width="10%">Variasi 1</td>
                @else
                    @if ($item->idKadar == 3)
                        <td width="10%">Variasi {{ $item->variasi }}</td>
                    @else
                        <td width="10%">Variasi 1</td>
                    @endif
                @endif
