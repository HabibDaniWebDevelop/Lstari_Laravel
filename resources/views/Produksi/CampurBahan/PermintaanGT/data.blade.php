                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="produk" name="produk" onchange="getProduk()" disabled="true">
                                        <option value="" selected>Pilih</option>
                                        <option value="KWTRG">KWTRG</option>
                                        <option value="UGGW">UGGW</option>
                                        <option value="KGATK">KGATK</option>
                                        <option value="KGJR">KGJR</option>
                                        <option value="KTG">KTG</option>
                                        <option value="Tag">Tag</option>
                                        <option value="Patri">Patri</option>
                                        <option value="Seri Veri">Seri Veri</option>
                                    </select>
                                </div>
                            </div>
