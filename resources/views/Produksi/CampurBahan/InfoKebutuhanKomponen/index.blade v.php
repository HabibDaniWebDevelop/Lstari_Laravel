                        ...
                        onRowClick: function(e) {  
                            ...
                            $.ajaxSetup({
                                ...
                                success:function(data){
                                    ...
                                    var dataGrid = $("#TableDevExtreme2").dxTreeList({
                                        ...
                                        columns: [
                                        {
                                            dataField: "SW", dataType: "string", format: 'dd-MM-yyyy', caption: "SPK PPIC",  cssClass: "cls", groupIndex: 0
                                        },                    
                                        {
                                        ...
                                        {
                                            dataField: "Operation", dataType: "string", caption: "Proses",  cssClass: "cls", groupIndex: 2
                                        },
                                        {
                                            dataField: "TglSPKO", dataType: "date", caption: "Tanggal SPKO",  cssClass: "cls"
                                        }, 
                                        {
                                        ...
                                        {
                                            dataField: "TglNTHKO", dataType: "date", caption: "Tanggal NTHKO",  cssClass: "cls"
                                        }, 
                                        {
