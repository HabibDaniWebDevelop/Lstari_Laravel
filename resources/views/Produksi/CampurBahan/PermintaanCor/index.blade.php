...
@section('Dashboard')
    ...
    <ol class="breadcrumb sm-2">
        ...
        <li class="breadcrumb-item active">Permintaan Cor </li>
    </ol>
@endsection
...
<script>
        ...
        function show1(){
            $.ajax({
                    url: '/Produksi/CampurBahan/PermintaanCor/getFilter',            
                    dataType : 'json',
                    type : 'GET',
        ...
        function pilihjenis(){
            ...
            data = {jenis:jenis};
            $.ajax({
                    url: '/Produksi/CampurBahan/PermintaanCor/getJenis',            
                    dataType : 'json',
                    type : 'GET',
                    data:data,
                    success: function(data)
        ...
        function getProduk(){
            ...
            $.ajax({
                    url: '/Produksi/CampurBahan/PermintaanCor/getProduk',            
                    dataType : 'json',
                    type : 'GET',
                    data:data,
                    success: function(data)
        ...
        function Klik_Simpan1() {
            ...
            if (checkbox.checked) {
                ...
                var type = "POST";
                var ajaxurl = '/Produksi/CampurBahan/PermintaanCor/saveOrder';
                // alert(formData);
                console.log(data);
                $.ajax({
                    type: type,
        ...
        function Klik_Cetak1() {
            id = $('#cari').val();
            window.open('/Produksi/CampurBahan/PermintaanCor/cetak?id=' + id, '_blank');
        }
        ...
        function ChangeCari() {
                ...
                $.ajax({
                    url: '/Produksi/CampurBahan/PermintaanCor/lihat',
                    data: data,
                    dataType: 'json',
                    type: 'POST',
                    success: function(data) {
