...
<script>
        ...
        function getSPKProduksi() {
            ...
            var data = {bln:bln, tahun:tahun, kadar:kadar, tgl1:tgl1, tgl2:tgl2};
            $.ajaxSetup({
                headers: {
                ...
                success:function(data){
                    ...
                    var dataGrid = $("#TableDevExtreme1").dxDataGrid({
                        ...
                        {
                            dataField: "TransDate", dataType: "string", caption: "Tanggal SPK", cssClass: "cls"
                        },                    
                        {
                        ...
                        {
                            dataField: "ACC", dataType: "string", caption: "Komponen",  cssClass: "cls",  groupIndex: 0
                        }, 
                        {
                            dataField: "ACC2", dataType: "string", caption: "Komponen",  cssClass: "cls",
                        }, 
                        {
                            dataField: "QtyKomponen", dataType: "number", caption: "Qty Komponen",  cssClass: "cls"
                        }, 
                        // {
                        ...
                        onRowClick: function(e) {  
                            ...
                            var rowData = e.data;
                           // console.log(rowData.IDKOM);
                            var id = rowData.IDKOM;
                            var kadar = rowData.KDR;
                            var data = {id:id, kadar:kadar};
                            $.ajaxSetup({
                                headers: {
                                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                    }
                                ...
                                success:function(data){
                                    ...
                                    var dataGrid = $("#TableDevExtreme2").dxDataGrid({
                                        ...
                                        columns: [
                                        {
                                            dataField: "Produk", dataType: "string",  caption: "Komponen",  cssClass: "cls"
                                        },                    
                                        {
                                            dataField: "Kadar", dataType: "string", caption: "Kadar", cssClass: "cls"
                                        }, 
