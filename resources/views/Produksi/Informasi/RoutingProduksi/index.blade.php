<?php $title = 'Informasi Routing Produksi'; ?>
<?php $tab='1'; ?>
<?php $tabdetail='1'; ?>
...
@section('Dashboard')
    ...
    <ol class="breadcrumb sm-2">
        ...
        <li class="breadcrumb-item active">Routing Produksi </li>
    </ol>
@endsection
...
<div class="row mb-4">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-md-row mb-3" >
        ...
        <div class="row" id="routingdetail" style="display:none; padding:5px 10px 0px 10px;">
            <ul class="nav nav-pills flex-column flex-md-row mb-3" >
                <li class="nav-item">
                    <a class="nav-link btn-tab1 {{ ($tabdetail === "1") ? 'active':' ' }}" id="idtabdetail1" data-bs-toggle="tab" href="#" onclick="showD1()">SPKO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn-tab2 {{ ($tabdetail === "2") ? 'active':' ' }}" id="idtabdetail2" data-bs-toggle="tab" href="#" onclick="showD2()">NTHKO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn-tab3 {{ ($tabdetail === "3") ? 'active':' ' }}" id="idtabdetail3" data-bs-toggle="tab" href="#" onclick="showD3()">Transfer RM</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn-tab4 {{ ($tabdetail === "4") ? 'active':' ' }}" id="idtabdetail4" data-bs-toggle="tab" href="#" onclick="showD4()">Transfer FG</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn-tab5 {{ ($tabdetail === "5") ? 'active':' ' }}" id="idtabdetail5" data-bs-toggle="tab" href="#" onclick="showD5()">Detail SPKO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn-tab6 {{ ($tabdetail === "6") ? 'active':' ' }}" id="idtabdetail6" data-bs-toggle="tab" href="#" onclick="showD6()">Detail NTHKO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn-tab7 {{ ($tabdetail === "7") ? 'active':' ' }}" id="idtabdetail7" data-bs-toggle="tab" href="#" onclick="showD7()">Detail Transfer RM</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn-tab8 {{ ($tabdetail === "8") ? 'active':' ' }}" id="idtabdetail8" data-bs-toggle="tab" href="#" onclick="showD8()">Detail Transfer FG</a>
                </li>
            </ul>
...
<script>
        ...
        function show1(){
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getFilter',            
                    dataType : 'json',
                    type : 'GET',
        ...
        function showD1(){
            ...
            data = {nospk:nospk};
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getSPKO',            
                    dataType : 'json',
                    type : 'GET',
                    data : data,
                    success: function(data)
                    {
                        ...
                        document.getElementById("routingdetail").style.display = "block";
                        var dataGrid = $("#TableDevExtreme3").dxDataGrid({
                            dataSource: data.tampil3,
                            showBorders: true,
                            ...
                            columns: [
                            {
                                dataField: "ID", dataType: "number",  caption: "ID",  cssClass: "cls"
                            },                    
                            {
                                dataField: "SW", dataType: "string",  caption: "No SPKO", cssClass: "cls"
                            }, 
                            {
                                dataField: "tgl", dataType: "date", format: 'dd-MM-yyyy', caption: "Tanggal",  cssClass: "cls"
                            },                        
                            {
                                dataField: "Location", dataType: "string", caption: "Area", cssClass: "cls"
                            }, 
                            {
                                dataField: "Operation", dataType: "string", caption: "Proses",  cssClass: "cls"
                            }, 
                            {
                                dataField: "Kadar", dataType: "string", caption: "Kadar",  cssClass: "cls"
                            },
                            {
                                dataField: "TotQty", dataType: "number", caption: "Total Qty",  cssClass: "cls"
                            }, 
                            {
                                dataField: "TotBerat", dataType: "number", caption: "Total Berat",  cssClass: "cls"
                            }, 
                            {
                                dataField: "SWUsed", dataType: "string", caption: "SPK PPIC",  cssClass: "cls"
                            }				          	          		           		          		                                                                                        
                            ],
                            // summary: {
                            //             groupItems: [{
        ...
        function showD2(){
            ...
            data = {nospk:nospk};
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getNTHKO',            
                    dataType : 'json',
                    type : 'GET',
                    data : data,
                    success: function(data)
                    {
                        ...
                        var dataGrid = $("#TableDevExtreme3").dxDataGrid({
                            ...
                            {
                                dataField: "SW", dataType: "string",  caption: "No NTHKO", cssClass: "cls"
                            }, 
                            {
                                dataField: "tgl", dataType: "date", format: 'dd-MM-yyyy', caption: "Tanggal",  cssClass: "cls"
                            },                        
                            ...
                            {
                                dataField: "TotQtyOK", dataType: "number", caption: "Total Qty OK",  cssClass: "cls"
                            }, 
                            {
                                dataField: "TotBeratOK", dataType: "number", caption: "Total Berat OK",  cssClass: "cls"
                            },
                            {
                                dataField: "TotQtyRep", dataType: "number", caption: "Total Qty Reparasi",  cssClass: "cls"
                            }, 
                            {
                                dataField: "TotBeratRep", dataType: "number", caption: "Total Berat Reparasi",  cssClass: "cls"
                            },  
                            {
                                dataField: "TotQtyScrap", dataType: "number", caption: "Total Qty Rusak",  cssClass: "cls"
                            }, 
                            {
                                dataField: "TotBeratScrap", dataType: "number", caption: "Total Berat Rusak",  cssClass: "cls"
                            }, 
                            {
                                dataField: "SWUsed", dataType: "string", caption: "SPK PPIC",  cssClass: "cls"
                            } 				          	          		           		          		                                                                                        
        ...
        function showD3(){
            ...
            data = {nospk:nospk};
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getTRM',            
                    dataType : 'json',
                    type : 'GET',
                    data : data,
                    success: function(data)
                    {
                        ...
                        var dataGrid = $("#TableDevExtreme3").dxDataGrid({
                            ...
                            {
                                dataField: "FromLoc", dataType: "string", caption: "Dari Area", cssClass: "cls"
                            }, 
                            {
                                dataField: "ToLoc", dataType: "string", caption: "Ke Area",  cssClass: "cls"
                            }, 
                            {
                                dataField: "Kadar", dataType: "string", caption: "Kadar",  cssClass: "cls"
                            },
        ...
        function showD4(){
            ...
            data = {nospk:nospk};
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getTFG',            
                    dataType : 'json',
                    type : 'GET',
                    data : data,
                    success: function(data)
        ...
        function showD5(){
            ...
            data = {nospk:nospk};
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getSPKOdetails',            
                    dataType : 'json',
                    type : 'GET',
                    data : data,
                    success: function(data)
                    {
                        ...
                        var dataGrid = $("#TableDevExtreme3").dxDataGrid({
                            ...
                            {
                                dataField: "Produk", dataType: "string", caption: "Produk",  cssClass: "cls"
                            },
                            {
                                dataField: "Qty", dataType: "number", caption: "Qty",  cssClass: "cls"
                            }, 
                            {
                                dataField: "Berat", dataType: "number", caption: "Berat",  cssClass: "cls"
                            }, 
                            {
                                dataField: "SWUsed", dataType: "string", caption: "SPK PPIC",  cssClass: "cls"
                            }				     				          	          		           		          		                                                                                        
        ...
        function showD6(){
            ...
            data = {nospk:nospk};
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getNTHKOdetails',            
                    dataType : 'json',
                    type : 'GET',
                    data : data,
                    success: function(data)
                    {
                        ...
                        var dataGrid = $("#TableDevExtreme3").dxDataGrid({
                            ...
                            {
                                dataField: "SW", dataType: "string",  caption: "No NTHKO", cssClass: "cls", groupIndex: 0
                            }, 
                            {
                                dataField: "tgl", dataType: "date", format: 'dd-MM-yyyy', caption: "Tanggal",  cssClass: "cls"
                            },                        
                            ...
                            {
                                dataField: "QtyOK", dataType: "number", caption: "Qty OK",  cssClass: "cls"
                            }, 
                            {
                                dataField: "BeratOK", dataType: "number", caption: "Berat OK",  cssClass: "cls"
                            },
                            {
                                dataField: "QtyRep", dataType: "number", caption: "Qty Reparasi",  cssClass: "cls"
                            }, 
                            {
                                dataField: "BeratRep", dataType: "number", caption: "Berat Reparasi",  cssClass: "cls"
                            },  
                            {
                                dataField: "QtyScrap", dataType: "number", caption: "Qty Rusak",  cssClass: "cls"
                            }, 
                            {
                                dataField: "BeratScrap", dataType: "number", caption: "Berat Rusak",  cssClass: "cls"
                            }, 
                            {
                                dataField: "SWUsed", dataType: "string", caption: "SPK PPIC",  cssClass: "cls"
                            } 				          	          		           		          		                                                                                        
        ...
        function showD7(){
            ...
            data = {nospk:nospk};
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getTRMdetails',            
                    dataType : 'json',
                    type : 'GET',
                    data : data,
                    success: function(data)
                    {
                        ...
                        var dataGrid = $("#TableDevExtreme3").dxDataGrid({
                            ...
                            {
                                dataField: "NTHKO", dataType: "string", caption: "NTHKO",  cssClass: "cls"
                            }, 
                            {
                                dataField: "SWUsed", dataType: "string", caption: "SPK PPIC",  cssClass: "cls"
                            }		  				          	          		           		          		                                                                                        
        ...
        function showD8(){
            ...
            data = {nospk:nospk};
            $.ajax({
                    url: '/Produksi/Informasi/RoutingProduksi/getTFGdetails',            
                    dataType : 'json',
                    type : 'GET',
                    data : data,
                    success: function(data)
                    {
                        ...
                        var dataGrid = $("#TableDevExtreme3").dxDataGrid({
                            ...
                            {
                                dataField: "ProdukD", dataType: "string", caption: "Deskripsi",  cssClass: "cls"
                            },                       
                            {
                                dataField: "Kadar", dataType: "string", caption: "Kadar",  cssClass: "cls"
                            },
        ...
        function getSPKProduksi() {
            ...
            if(jenis == 2){
                var data = {bln:bln, tahun:tahun, kadar:kadar};
                $.ajaxSetup({
                    headers: {
                    ...
                    $.ajax({
                    type:'GET',
                    url: '/Produksi/Informasi/RoutingProduksi/getSPKProduksi', 
                    beforeSend: function () {
                        $(".preloader").show();  
                    },
                    data: data,
                                ...
                                $.ajaxSetup({
                                    ...
                                    success:function(data){
                                        ...
                                        var dataGrid = $("#TableDevExtreme2").dxDataGrid({
                                            ...
                                            columns: [
                                            {
                                                dataField: "SW", dataType: "string",  caption: "SPK PPIC",  cssClass: "cls", groupIndex: 0
                                            },                    
                                            {
                                                dataField: "FG", dataType: "string", caption: "Produk Jadi", cssClass: "cls", groupIndex: 1
                                            }, 
                                            {
                                                dataField: "KadarWO", dataType: "string", caption: "Kadar",  cssClass: "cls"
                                            },                        
                                            {
                                                dataField: "SPKO", dataType: "string", caption: "SPKO", cssClass: "cls", groupIndex: 3
                                            }, 
                                            {
                                                dataField: "LokasiSPKO", dataType: "string", caption: "Lokasi",  cssClass: "cls"
                                            },
                                            {
                                                dataField: "XX", dataType: "string", caption: "Proses",  cssClass: "cls", groupIndex: 2
                                            },
                                            {
                                                dataField: "TglSPKO", dataType: "date", format: 'dd-MM-yyyy', caption: "Tanggal SPKO",  cssClass: "cls"
                                            }, 
                                            {
                                                dataField: "PSPKO", dataType: "string", caption: "Produk",  cssClass: "cls"
                                            }, 
                                            {
                                                dataField: "KadarSPKO", dataType: "string", caption: "Kadar",  cssClass: "cls"
                                            },
                                            {
                                                dataField: "QtySPKO", dataType: "string", caption: "Qty SPKO",  cssClass: "cls"
                                            },	
                                            {
                                                dataField: "BeratSPKO", dataType: "string", caption: "Berat SPKO",  cssClass: "cls"
                                            }, 
                                            {
                                                dataField: "NTHKO", dataType: "string", caption: "NTHKO",  cssClass: "cls", groupIndex: 4
                                            }, 	
                                            {
                                                dataField: "TglNTHKO", dataType: "date", format: 'dd-MM-yyyy', caption: "Tanggal NTHKO",  cssClass: "cls"
                                            }, 
                                            {
                                                dataField: "PNTHKO", dataType: "string", caption: "Produk", cssClass: "cls"
                                            }, 
                                            {
                                                dataField: "Qty", dataType: "string", caption: "Qty", cssClass: "cls"
                                            }, 	          		          
                                            {
                                                dataField: "ScrapQty", dataType: "string", caption: "ScrapQty", cssClass: "cls",
                                            },  
                                            {
                                                dataField: "RepairQty", dataType: "string", caption: "RepairQty", cssClass: "cls",
                                            },  	           	          
                                            {
                                                dataField: "Weight", dataType: "string", caption: "Berat", cssClass: "cls"
                                            },  	          
                                            {
                                                dataField: "ScrapWeight", dataType: "string", caption: "ScrapWeight", cssClass: "cls"
                                            },  	          
                                            {
                                                dataField: "RepairWeight", dataType: "string", caption: "RepairWeight", cssClass: "cls"
                                            }             				          	          		           		          		                                                                                        
                                            ],
                                            // summary: {
                                            //             groupItems: [{
            ...
            if(jenis == 1){
                ...
                if(spk > 0){
                    ...
                    if(tab == "idtabdetail1"){showD1();}
                    else if(tab == "idtabdetail2"){showD2();}
                    else if(tab == "idtabdetail3"){showD3();}
                    else if(tab == "idtabdetail4"){showD4();}
                    else if(tab == "idtabdetail5"){showD5();}
                    else if(tab == "idtabdetail6"){showD6();}
                    else if(tab == "idtabdetail7"){showD7();}
                    else if(tab == "idtabdetail8"){showD8();}
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'Oops...',
                        text: "SPK PPIC Tidak Boleh Kosong !",
                    })
                    return;
                }
                //document.getElementById("routingproduksi").style.display = "none";
