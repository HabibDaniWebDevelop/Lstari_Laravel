...
<body>
    @php    
        if($jenis == 7){
            ...
            $jenislaporan = 'Report Performance';
            $grup = 'Operator';
            $grup2 = 'Operator';
        }
    @endphp
    ...
    <table class="table" id="tampiltabel" style="width: 100%; border: 1px solid black;"> 
        <thead>
            <tr bgcolor="#111111">
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">No</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Operator</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">No SPK</th> 
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">No SPKO</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Tgl SPKO</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Tgl NTHKO</th> 
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Jenis</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">FinishGood</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Kadar</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Operation</th> 
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Qty SPKO</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Brt SPKO</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Qty NTHKO (Good)</th> 
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Qty NTHKO (Rep)</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Qty NTHKO (SS)</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Brt NTHKO (Good)</th> 
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Brt NTHKO (Rep)</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Brt NTHKO (SS)</th>
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Persen (Good)</th> 
                <th class="text-center" style="border-bottom: 1px solid black; border-right: 1px solid black; font-size: 12px; font-weight: bold; color: rgb(88, 88, 223)">Persen (Rep)</th>
        ...
        @foreach ($byGroup as $keyi => $dataku) 
            ...
            <tr bgcolor="yellow" style="black: white">
                <td style="border-bottom: 1px solid black; font-size : 11px; color: magenta;" colspan="21"><b>{{$grup2}} : {{$keyi}} ({{count($dataku)}})<b></td>
            </tr>
            ...
            @php
                if($datas['TglSPKO'] <> NULL){
                    $tglSPKO = date('d/m/y', strtotime($datas['TglSPKO']));
                }else{
                    $tglSPKO = NULL;
                }
                if($datas['TglNTHKO'] <> NULL){
            ...
            <tr bgcolor="#E9967A" style="black: white; font-weight: bold"><td style="border-bottom: 1px solid black; font-size : 11px; color: {{$colorstatus}};" colspan="10" align="right">Sub Total : </td>
        ...
        <tr bgcolor="#E9967A" style="black: white; font-weight: bold">
            <td style="font-size: 12px; color: green;" colspan="10" align="right">Grand Total : </td>
