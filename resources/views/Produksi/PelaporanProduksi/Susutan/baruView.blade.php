...
<form id="tampilform" > 
            ...
            <div class="row">
                <div class="col-md-4 mb-2">
                    <div class="form-group">
                        ...
                        <input type="hidden" id="prosesid" name="prosesid" value="{{$datas->ProsesID}}">
                ...
                <div class="col-md-4 mb-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="background-color:transparent; color: blue; font-weight: bold" id="tglnow" name="tglnow" value="{{$tglnow}}" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4 mb-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="background-color:transparent; color: blue; font-weight: bold" name="toleransi" id="toleransi" value="0.00" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label" style="font-size: 13px; font-weight: bold; color: black; text-transform: capitalize;">Perbedaan</label>
                        <input type="text" class="form-control" style="background-color:transparent; color: blue; font-weight: bold" name="perbedaan" id="perbedaan" value="{{$datas->Perbedaan}}" readonly>
                    </div>
                </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-7">
            <input type="text" class="form-control" style="background-color:transparent; color: blue; font-weight: bold" name="catatan" id="catatan">
        </div>
    </div>
    ...
    <table class="table table-striped text-nowrap" id="tampiltabel" style="min-width: 100%">
        ...
        <tbody>
            @foreach ($data2 as $datas2)
                <tr>
                    {{-- <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $loop->iteration }}</td>
                    <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $datas2->NoSPK }}</td>
                    <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $datas2->Produk }}</td>
                    <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $datas2->QtySpko }}</td>
                    <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $datas2->QtyNthko }}</td>
                    <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $datas2->WeightSpko }}</td>
                    <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $datas2->WeightNthko }}</td>
                    <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $datas2->JmlSelisih }}</td>
                    <td align="center" style="font-size: 15px; font-weight: bold; color: black;">{{ $datas2->BrtSelisih }}</td> --}}
