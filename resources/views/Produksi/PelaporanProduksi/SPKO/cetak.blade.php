...
<body>
    ...
    <table class="table2" width="100%" border="0">
        ...
        <tbody>
            ...
            <tr>
                <td align="center" style="border-bottom: 1px solid black; font-size: 11px; color: black" colspan="1" rowspan="2">{{$no}}</td>
                ...
                <td align="center" style="font-size: 11px; color: black" colspan="1" >{{$dataItems->WorkSchedule}}</td> 
                @if($dataItems->BatchNo == 'null')
                    <td align="center" style="font-size: 11px; color: black" colspan="2" ></td> 
                @else
