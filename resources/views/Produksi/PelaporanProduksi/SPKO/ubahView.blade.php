    ...
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="row" style="padding-top: 5px;">
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" style="font-size: 11px">No SPKO :</label>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-7">
                            <select class="form-select form-select-sm" name="proses" id="proses" tabindex="3">
                                ...
                                @foreach ($proses as $prosess)
                                    <option value="{{$prosess->ID}},{{$prosess->Product}}">{{$prosess->Description}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="row" style="padding-top: 5px;">
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control form-control-sm" type="text" id="karyawan" name="karyawan" value="{{$headers->ESW}}" onchange="cariKaryawan(this.value)" tabindex="4">
                        </div>
                        <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input class="form-control form-control-sm" type="text" id="workgroup" name="workgroup" value="{{$headers->WorkGroup}}" onchange="cariWorkgroup(this.value)" tabindex="5">
                        </div>
                        <div class="col-md-6">
                            <label id="workgrouplabel" style="font-weight:bold; color: blue; font-size: 12px">{{$headers->EGroup}}</label>
...
<div class="row">
    <div class="col-md-2">     
        <div class="form-group row">
            <div class="col-md-12">
                <input class="form-control form-control-sm" type="text" id="barcodeall" name="barcodeall" placeholder="Barcode Semua"  onchange="klikBarcodeAll(this.value)" tabindex="6">
            </div>
        </div>
    </div>
    <div class="col-md-2">     
        <div class="form-group row">
            <div class="col-md-12">
                <input class="form-control form-control-sm" type="text" id="barcodeunit" name="barcodeunit" placeholder="Barcode Tunggal" onchange="klikBarcodeUnit(this.value)" tabindex="7">
            </div>
        </div>
    </div>
    <div class="col-md-1">
    ...
    <div class="col-md-1">
        <div class="form-group row">
            <label style="font-size: 12px; font-weight:bold; color: black;">Seconds :</label>
    ...
    <div class="col-md-1">
        <div class="form-group row">
            <label style="font-size: 12px; font-weight:bold; color: black;">Percent :</label>
