        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input class="form-control" id="Caratshow" type="hidden" name="Caratshow"
                        value="{{$dapattm3dp[0]->carat}}" disabled="true">
                </div>
            </div>

            <div class="col-md-6">
                <label class="form-label" for="basic-icon-default-fullname">Rph Lilin</label>
                <input class="form-control" id="idtmshow" type="" name="idtmshow" value="{{$dapattm3dp[0]->rph}}"
                    disabled="true" onchange="RPH()">
            </div>
        </div>
