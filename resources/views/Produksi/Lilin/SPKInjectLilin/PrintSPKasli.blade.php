...
<body>
    ...
    <table class="tabel0" style="background-color: #F0FFF0;">
        <tr>
            <td colspan="3" style="font-size:20px; padding-bottom: 10px; "><b>SPKO Inject Lilin </b> <span
    ...
    <div id="karet">
        <table class="tabel0" style="background-color: #F0FFF0;">
            <tr>
                <td colspan="1" style="font-size:20px; padding-bottom: 10px; padding-right: 0px; "><b>
                        Kebutuhan karet </b>
                </td>
            ...
            <!-- <tr>
            <td hidden width="100">ID SPK</td>
            <td hidden width="2">:</td>
            <td hidden width="140"><b>{{ $printdataspk[0]->ID }}</b></td>
            <input type="hidden" id="IDSPK" value=" {{  $printdataspk[0]->ID }}">

            <td hidden width="110">Piringan</td>
            <td hidden width="2">:</td>
            <td width="150"><b>{{ $printdataspk[0]->pkaret }}</b> - [{{ $printdataspk[0]->RubberPlate }}]</td>

            <td hidden width="100">Kadar</td>
            <td width="2">:</td>
            <td width="200"><b>{{ $printdataspk[0]->kadar }}</b></td>
            <input type="hidden" id="color" value="{{$printdataspk[0]->HexColor }}">
        </tr>

        <tr>
            <td hidden >Nama Operator</td>
            <td hidden >:</td>
            <td hidden > <b>{{ $printdataspk[0]->emp }}</b> - [{{ $printdataspk[0]->IDK }}]</td>

            <td hidden >Admin Persiapan</td>
            <td hidden >:</td>
            <td hidden >{{ $printdataspk[0]->UserName }}</td>

            <td hidden >Tanggal</td>
            <td hidden >:</td>
            <td hidden ><?php echo tgl_indo($printdataspk[0]->TransDate); ?></td>
        </tr>

        <tr>
            <td hidden >Kelompok</td>
            <td hidden >:</td>
            <td><b>{{ $printdataspk[0]->WorkGroup }}</b></td>

            <td hidden >NO. Kotak</td>
            <td hidden >:</td>
            <td hidden ><b>{{ $printdataspk[0]->BoxNo }}</b></td>

            <td hidden >Stick Pohon</td>
            <td hidden >:</td>
            <td hidden >{{ $printdataspk[0]->stickpohon}} </td>
        </tr>
        <tr>
 ...
 -->
    ...
    <div id="batu">
        ...
        <table class="tabel0" style="background-color: #F0FFF0;">
            <tr>
                <td colspan="3" style="font-size:20px; padding-bottom: 10px; "><b>Kebutuhan batu </b>
                </td>
                <td colspan="2" style="text-align: right;"><b>{{ $printdataspk[0]->kadar }}</b></td>
                <td>
                    <div id="colorcadar" class="colorcadar"
        ...
        <table class="tabel0" style="background-color: #F0FFF0;">
            ...
            <td width="100">ID SPK</td>
            <td width="2">:</td>
            <td width="140"><b>{{ $printdataspk[0]->ID }}</b></td>
            <input type="hidden" id="IDSPK" value=" {{  $printdataspk[0]->ID }}">
        ...
        <tr>
            ...
            <td>Stick Pohon</td>
            <td>:</td>
            <td>{{ $printdataspk[0]->stickpohon}} </td>
        </tr>
        <tr>
...
//     document.getElementById("batu").prop('hidden', false)
// }
