...
<body>
    ...
    <table class="tabel0" style="background-color: #F0FFF0;">
        <tr>
            <td colspan="6" style="font-size:20px; padding-bottom: 10px; "><b>SPK Inject Lilin </b> <span
                    style="display: none"
            ...
            <td rowspan="5" style="height: 50px; text-align: center; padding-top: 10px;">
                ...
                <span style="text-align: center; vertical-align: text-top;">{{ $printdataspk[0]->ID }} </span>
    ...
    <table class="table table-border table-hover table-sm" id="tabel1">
        ...
        <table>
            ...
            <tr>
                ...
                <td style="padding-left: 140px; vertical-align: text-top;">( .............. )</td>
                <td style=" padding-left: 60px;"> </td>
            </tr>
        </table>
        <table>
    ...
    <div id="karet">
        <table class="tabel0" style="background-color: #F0FFF0;">
            <tr>
                <td colspan="10" style="font-size:20px; padding-bottom: 10px; padding-right: 120px; "><b>
                        Kebutuhan karet </b>
                </td>
 ...
 -->
            ...
            <table>
                ...
                <tr>
                    <td style="height: 50px; text-align: center; padding-top: 10px;">
                        <div style="display: flex; justify-content: center; text-align: center;" id="qrcode1"></div>
                    </td>
                    <td style="padding-left: 50px"> Diberikan Oleh</td>
                    <td style="padding-left: 130px"> Diterimah Oleh</td>
    ...
    <div id="batu">
        ...
        <table class="tabel0" style="background-color: #F0FFF0;">
            <tr>
                <td colspan="8" style="font-size:20px; padding-bottom: 10px; padding-right: 120px;"><b>
