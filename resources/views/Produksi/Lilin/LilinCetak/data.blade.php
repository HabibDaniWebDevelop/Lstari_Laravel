    ...
    <div class="row" center>
        <div class="col-4">
            ...
            <label class="form-label" style="text-align: center; font-weight: bold; color: #80271c;" for="Rusak">
                ...
                <h6 style="text-align: center; font-weight: bold; color: #80271c;">&nbsp;&nbsp;&nbsp;&nbsp; Jumlah Rusak
                    :
                    &nbsp;&nbsp;<span id="Jumlah_Rusak"></span></h6>
            </label>
        </div>
        <div class="col-4">
            <label class="form-label" style="text-align: center; font-weight: bold; color: #80271c;" for="Setor">

                <h6 style="text-align: center; font-weight: bold; color: #80271c;">&nbsp;&nbsp;&nbsp;&nbsp; Jumlah Setor
                    :
                    &nbsp;&nbsp;<span id="Jumlah_Setor"></span></h6>
            </label>
        </div>
        <div class="col-4">
            <label class="form-label" style="text-align: center; font-weight: bold; color: #80271c;" for="Cetak">

                <h6 style="text-align: center; font-weight: bold; color: #80271c;">&nbsp;&nbsp;&nbsp;&nbsp; Jumlah Cetak
                    :&nbsp;&nbsp;<span id="Jumlah_Cetak"></span></h6>
            </label>
        </div>
    </div>
    <div class="row">
