        ...
        <div class="card">
            <div class="card-body">
                <div class="demo-inline-spacing mb-4">
                    ...
                    <button type="button" class="btn btn-primary me-4" id="Baru1" onclick="Tambah_SPKO()"><span
                            class="tf-icons bx bx-plus-circle"></span>&nbsp; Order Tambahan Inject </button>
                    <button type="button" class="btn btn-primary me-4" id="Baru2" onclick="Tambah_SPKPohon()"><span
                            class="tf-icons bx bx-plus-circle"></span>&nbsp; order Tambahan DC </button>
                    ...
                    <button type="button" hidden class="btn btn-warning me-4" id="permintaan3dp" disabled
                        onclick="prosesminta()">
                    ...
                    <button type="button" hidden class="btn btn-info" id="Cetak2" disabled onclick="printSPK3DP()">
                        <span class="tf-icons bx bx-printer"></span>&nbsp; Cetak Request</button>
...
@include('Produksi.Lilin.OrderTambahanLilin.Modal')