<div class="row">
    ...
    <div class="col-md-3">
        <div class="input-group input-group-merge">
            ...
            <input class="form-control" style="text-align: center" id="totalQtyDC" type="number" name="totalQty"
                value="" disabled="true">
                ...
                <tr class="klik2" id="{{ $loop->iteration }}" style="text-align: center">
                    <td>
                        <input class="form-check-input itemdrc" type="checkbox" name="id[]"
                            ...
                            data-product="{{$itemdirect->IDprod}}" data-Qty="{{$itemdirect->TQty}}"
                            ...
                            data-QtySatuPohon="{{$itemdirect->QtySatuPohon}}" disabled>
                    </td>
...
<div class="d-grid gap-2 d-md-flex justify-content-md-end px-4 mt-3">
    <button type="button" class="btn btn-primary mb-2 " onclick="OrderKomponen3DP()">Buat SPK ke 3DP</button>
