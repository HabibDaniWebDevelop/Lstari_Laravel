<div class="row">
    ...
    <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="NamaOperator"
                                    style="font-weight: bold; color: #80271c;" placeholder="nama operator" disabled
                                    value="" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="FormTotalQty"
                                    style="font-weight: bold; color: #80271c;" value="" placeholder="0" readonly />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="px-5">
            <div class="row">
                <label class="form-label" for="basic-icon-default-fullname">SPK PPIC</label>
                <div class="col-md-9">
                    <div class="mb-3">
                        <div class="input-group input-group-merge">
                            <input type="text" list="ListSWWorkOrder" class="form-control border-primary border-4"
                                id="SWWorkOrder" placeholder="" tabindex="7" />
                        </div>
                        <datalist id="listSWWorkOrder">
                            @foreach ($ListSWWorkOrder AS $SW)
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <div class="d-grid gap-2">
                            <button type="button" class="btn btn-primary" id="daftarpro" onclick="Klickdaftarproduct()">
                                <span class="tf-icons bx bx-list-ul"></span>&nbsp; Daftar Item </button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge"><input type="text" class="form-control"
                                        id="Kadar" placeholder="" disabled value="" /></div>
                                <input type="hidden" id="KadarId" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge"><input type="text" class="form-control"
                                        id="rphlilin" placeholder="" disabled value="" /></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="IdPiring"
                                        style="font-weight: bold; color: #80271c;" placeholder="" disabled value="" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge" id="pohon">
                            <select class="form-select" id="stickpohon" tabindex="8">
                                ...
                                <option value="{{ $stickp->ID }}">{{ $stickp->stickpohon }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
<div class="showtabelitem" id="showtabelitem">
...
$(document).on('keypress', 'input,textarea,select', function(e) {
    if (e.which == 13) {
        ...
        // $(this).parent().parent().parent().next('div').find('input').focus();
        ...
        // $(this).parent().parent().parent().next('div').find('textarea').focus();
        // $(this).parent().parent().parent().parent().next('div').find('textarea').focus();

        // $(this).parent().next('div').find('select').focus();
        // $(this).parent().parent().next('div').find('select').focus();
        // $(this).parent().parent().parent().next('div').find('select').focus();
        // $(this).parent().parent().parent().parent().next('div').find('select').focus();
    }
});
</script>