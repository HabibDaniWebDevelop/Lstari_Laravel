<div class="card-body">
    <div class="row">
        <div class="col-9">
            ...
            <button type="button" class="btn btn-warning" disabled="" id="btn_batal" onclick="klikBatal()"> <span
                    class="fas fa-times-circle"></span>&nbsp; Batal</button>
            <button type="button" class="btn btn-danger me-4" disabled="" id="btn_simpan" onclick="KlikSimpan()"><span
                    class="tf-icons bx bx-save"></span>&nbsp; UnReg Karet</button>
        ...
        <table hidden class="table table-border table-hover table-sm rounded-4" id="tabel1">
            ...
            <tbody class="text-center">
                <tr style="text-align: center">
                    ...
                    <td><input type="text" class="form-control form-control-sm fs-6 w-100 text-center Keterangan"
                            id="Keterangan_1" value=""></td>
