...
class KoreksiMRController extends Controller
{
    ...
    public function Index(Request $request)
    {
        ...
        return view('Inventori.MaterialRequest.KoreksiMR.index', compact('ListUserHistory', 'satuan', 'barangStock'));
    }
    ...
    public function show(Request $request)
    {
        if ($request->menu == 'lihat') {
            ...
            return view('Inventori.MaterialRequest.KoreksiMR.show', compact('menu', 'header', 'items', 'satuan', 'barangStock','Locations'))->render();
            ...
            return view('Inventori.MaterialRequest.KoreksiMR.show', compact('menu', 'header'))->render();
