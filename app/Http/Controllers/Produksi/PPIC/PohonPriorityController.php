...
class PohonPriorityController extends Controller{
    // set public function
    ...
    public function Index(){
        ...
        return view('Produksi.PPIC.PohonPriority.index', compact('datenow'));
    }
 ...
 THEN 'MediumSeaGreen' ELSE 'Gray' END infomodel
    ...
    public function cetak($Priority){
       ...
       WHERE
           ...
           return view('Produksi.PPIC.PohonPriority.cetak',compact('username','Waxtreeitem','date','datenow','timenow'));
