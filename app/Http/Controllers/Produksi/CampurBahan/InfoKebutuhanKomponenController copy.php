...
class InfoKebutuhanKomponenController extends Controller
{
    public function index(){
        return view('Produksi.CampurBahan.InfoKebutuhanKomponen.index');
    }
    ...
    public function getFilter(){
        ...
        ");
        //dd($data);
        $returnHTML =  view('Produksi.CampurBahan.InfoKebutuhanKomponen.data', compact('data', 'kadar'))->render();
    ...
    public function getSPKProduksi(Request $request){
        ...
        //dd($dataspk);
        $returnHTML =  view('Produksi.CampurBahan.InfoKebutuhanKomponen.SPKProduksi')->render();
    ...
    public function getSPKRouting(Request $request){
        ...
        ");
        //dd($datadetail);
        $returnHTML =  view('Produksi.CampurBahan.InfoKebutuhanKomponen.Routing')->render();
